package eu.opencloud.android.files.details
...
import eu.opencloud.android.sharing.shares.ui.TestShareFileActivity
import eu.opencloud.android.testutil.OC_ACCOUNT
import eu.opencloud.android.testutil.OC_FILE
import eu.opencloud.android.testutil.OC_FILE_WITH_SYNC_INFO_AVAILABLE_OFFLINE
...
import eu.opencloud.android.testutil.OC_FILE_WITH_SYNC_INFO_AND_WITHOUT_PERSONAL_SPACE
...
import eu.opencloud.android.utils.matchers.withDrawable

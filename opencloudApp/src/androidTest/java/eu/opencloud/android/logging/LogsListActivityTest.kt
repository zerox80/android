...
package eu.opencloud.android.logging
...
import eu.opencloud.android.utils.matchers.assertChildCount
...
class LogsListActivityTest {
    ...
    @Test
    fun test_childCount() {
        launchTest(logs = listOf(File("opencloud.2021-01.01.log"), File("opencloud.2021-01-02.log")))

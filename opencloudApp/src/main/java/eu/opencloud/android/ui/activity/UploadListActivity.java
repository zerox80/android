...
import eu.opencloud.android.operations.CheckCurrentCredentialsOperation;
import eu.opencloud.android.presentation.authentication.AccountUtils;
import eu.opencloud.android.presentation.transfers.TransferListFragment;
...
public class UploadListActivity extends FileActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == FileActivity.REQUEST_CODE__UPDATE_CREDENTIALS && resultCode == RESULT_OK) {
            ...
            Account account = AccountUtils.getOpenCloudAccountByName(
                    this,
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN) {
            if (findViewById(R.id.opencloud_app_bar).hasFocus()) {

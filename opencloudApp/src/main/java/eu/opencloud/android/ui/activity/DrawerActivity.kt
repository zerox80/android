...
import eu.opencloud.android.extensions.sendEmailOrOpenFeedbackDialogAction
...
abstract class DrawerActivity : ToolbarActivity() {
    ...
    protected fun setAccountInDrawer(account: Account) {
        if (getDrawerLayout() != null) {
            ...
            try {
                val ocAccount = OpenCloudAccount(account, this)
    ...
    companion object {
        const val GITHUB_URL = "https://github.com/orgs/opencloud-eu/discussions"

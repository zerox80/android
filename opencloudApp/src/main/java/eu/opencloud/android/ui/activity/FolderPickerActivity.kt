...
open class FolderPickerActivity : FileActivity(),
            ...
            when (pickerMode) {
                ...
                PickerMode.CAMERA_FOLDER -> {
                    ...
                    if (spaceId != null) {
                        ...
                        account = AccountUtils.getOpenCloudAccountByName(this, accountName)
                        // Show the personal space
                        initAndShowListOfFilesFragment(spaceId = null)
                    }
                }
    ...
    private fun initAndShowListOfFilesFragment(spaceId: String? = null) {
        val safeInitialFolder = if (file == null) {
            if (account == null) {
                account = AccountUtils.getCurrentOpenCloudAccount(applicationContext)
            }
    ...
    private fun initAndShowListOfSpaces() {
        ...
        val accountName = accountNameIntent ?: AccountUtils.getCurrentOpenCloudAccount(applicationContext).name

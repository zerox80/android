...
import eu.opencloud.android.presentation.sharing.sharees.ShareUserListAdapter
import eu.opencloud.android.presentation.sharing.shares.SharePublicLinkListAdapter
...
class ShareFileFragment : Fragment(), ShareUserListAdapter.ShareUserAdapterListener,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (file!!.isImage) {
            binding.shareFileIcon.load(ThumbnailsRequester.getPreviewUriForFile(file!!, account!!), ThumbnailsRequester.getCoilImageLoader(account!!)) {
    ...
    companion object {
         ...
         * @param account     An openCloud account

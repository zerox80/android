...
package eu.opencloud.android.data.spaces.db
...
import eu.opencloud.android.data.spaces.db.SpacesEntity.Companion.SPACES_QUOTA_REMAINING
import eu.opencloud.android.data.spaces.db.SpacesEntity.Companion.SPACES_QUOTA_STATE
import eu.opencloud.android.data.spaces.db.SpacesEntity.Companion.SPACES_QUOTA_TOTAL
import eu.opencloud.android.data.spaces.db.SpacesEntity.Companion.SPACES_QUOTA_USED
import eu.opencloud.android.data.spaces.db.SpacesEntity.Companion.SPACES_ROOT_DELETED_STATE
import eu.opencloud.android.data.spaces.db.SpacesEntity.Companion.SPACES_ROOT_ETAG
import eu.opencloud.android.data.spaces.db.SpacesEntity.Companion.SPACES_ROOT_ID
import eu.opencloud.android.data.spaces.db.SpacesEntity.Companion.SPACES_ROOT_WEB_DAV_URL

...
package eu.opencloud.android.domain.server.usecases

import eu.opencloud.android.domain.BaseUseCaseWithResult
import eu.opencloud.android.domain.exceptions.NOT_HTTP_ALLOWED_MESSAGE
...
import eu.opencloud.android.domain.server.model.ServerInfo.Companion.HTTPS_PREFIX
import eu.opencloud.android.domain.server.model.ServerInfo.Companion.HTTP_PREFIX
